...
document.querySelector('#yarn-form').addEventListener('submit', async function(event) {
  ...
  try {
    const response = await fetch('https://sheets.googleapis.com/v4/spreadsheets/YOUR_SPREADSHEET_ID/values/SSmithYarn:append?valueInputOption=RAW&key="-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n"', {
      method: 'POST',
      headers: {
