...
document.querySelector('#yarn-form').addEventListener('submit', async function(event) {
  ...
  try {
    const response = await fetch('https://sheets.googleapis.com/v4/spreadsheets/16jODbEF0qWJLOgeCXJamc6Bv3HfoP9xevSBNwH-U4_I/values/SSmithYarn:append?valueInputOption=RAW&key="-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n"', {
      method: 'POST',
      headers: {
